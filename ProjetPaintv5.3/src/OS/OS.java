...
public class OS extends JPanel{
	...
	public static Boolean errorserver = false;
	...
	public void soustraction() {
    	if (selected.size() == 2 && selected.get(0) instanceof Rectangle && selected.get(1) instanceof Rectangle) {
            Rectangle rect1 = (Rectangle) selected.get(0);
            Rectangle rect2 = (Rectangle) selected.get(1);
               
            ArrayList<Rectangle> resultRectangles = Substract.subtractRectangles(rect1, rect2);            
           
            Union union = new Union();
            for (Rectangle rect : resultRectangles) {
                shapes.add(rect);
                union.add(rect);
            }
            shapes.remove(rect1);
